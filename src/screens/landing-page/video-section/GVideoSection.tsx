  ...
  return (
    <>
      <div className="w-full mx-auto flex flex-col md:flex-row justify-center items-center py-16 md:py-24 lg:py-36 p-12 bg-[#ebebec] gap-8 md:gap-14">
        <h1 className="text-4xl font-bold text-gray-800 mb-4 md:mb-0 md:text-3xl lg:text-4xl max-w-md text-center md:text-left">
          {title}
        </h1>
        <p className="text-md text-gray-600 md:text-md lg:text-lg lg:max-w-lg max-w-md text-center md:text-left">
          {subtitle}
        </p>
      </div>
      <video
