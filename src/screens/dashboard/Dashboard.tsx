...
const Dashboard: React.FC<DashboardProps> = ({ overrideComponent  }) => {
  const sidebarItems: SidebarItem[] = [
    ...
    { id:1, icon: CgNotes, text: "Ausschreibungen", subItems: [{ id: 10, text: "Alle Ausschreibungen", component:<Tenders /> }, { id: 11, text: "Neue hinzufügen", component: <NewTender key={Date.now()}/>}]},
