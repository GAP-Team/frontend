        ...
        <form onSubmit={formik.handleSubmit}>
            <Grid container spacing={2}>
                        ...
                        <Grid item>
                            <Button variant="outlined" component="label">
                                ...
                                <input
                                    ...
                                    hidden
                                    onChange={(e) =>
                                        formik.setFieldValue("logo", e.target.files?.[0] ? URL.createObjectURL(e.target.files[0]) : null)
                                    }
                                />
                            </Button>
                        </Grid>
                ...
                <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" color="textSecondary" sx={{ mb: 1 }}>
                        Geben Sie Ihre echte Adresse an, damit wir wichtige Informationen senden können.
                    </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                    <Grid container spacing={2}>
