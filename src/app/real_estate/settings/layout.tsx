...
const menuItems = [
    ...
    { label: "Unternehmens Informationen", href: "/real_estate/settings/company_profile" },
    ...
    { label: "Account löschen", href: "/real_estate/settings/delete_account", style: { color: "red" } },
];
