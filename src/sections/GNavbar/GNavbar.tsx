  ...
  return (
    <nav className="container p-4 mx-auto lg:flex lg:justify-between lg:items-center bg-opacity-70">
      <div className="flex items-center justify-between">
        <Link href="#" className="flex flex-row justify-start items-center gap-4">
          ...
          <Image
            ...
            src={gapLogo}
          />
          <p className={`${lalezar.className} text-[#0D1F4E] text-3xl md:text-5xl  text-center md:mt-3 `}> {/* Ensure text is centered */}
            GAP
          </p>
      ...
      <div className={`absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white shadow-md lg:bg-transparent lg:dark:bg-transparent lg:shadow-none dark:bg-gray-900 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center ${isOpen ? 'translate-x-0 opacity-100' : 'opacity-0 -translate-x-full'}`}>
        <div className="flex flex-col space-y-4 lg:mt-0 lg:flex-row lg:-px-8 lg:space-y-0">
          <a className="text-gray-700 transition-colors text-lg font-semibold duration-300 transform lg:mx-8 dark:text-gray-200 dark:hover:text-blue-400 hover:text-[#005e99]" href="#">Startseite</a>
          <a className="text-gray-700 transition-colors text-lg font-semibold duration-300 transform lg:mx-8 dark:text-gray-200 dark:hover:text-blue-400 hover:text-[#005e99]" href="#">Für Dienstleister</a>
