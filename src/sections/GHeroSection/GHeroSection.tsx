...
import { germanStates, listOfOrderTypes, listOfTrades } from '@/Constants';
                ...
                <div className="w-full xl:mb-0 xl:px-16">
                  <div className="bg-white bg-opacity-90 rounded-xl shadow-2xl p-4 sm:p-7 md:p-10">
                    <div className="flex justify-center flex-col items-center text-center pb-5 px-4 md:px-5">
                      <Badge title="In 3 Schritten zum Erfolg" color="#d0ede8" />
                      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold my-5">Unternehmen gesucht?</h1>
                      <p className="text-base sm:text-lg md:text-xl font-normal max-w-xl sm:max-w-2xl md:max-w-4xl mx-auto py-2">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, rem neque doloribus impedit explicabo minus laborum cupiditate atque esse consectetur.
                      </p>
                    </div>
                    <form className="flex flex-col justify-center text-center pt-10 pb-4 md:flex-row">
                      <div className="flex flex-col w-full px-2 sm:px-4 md:w-1/3">
                        ...
                        <Dropdown label="Gewerke" size="lg" color="gray" style={{ width: '90%', alignSelf: 'center', margin: 2 }}>
                    ...
                    <div className="flex justify-center items-center">
                      <Button as='a' href="#" className='mt-10 text-lg bg-[#005e99] hover:bg-[#0071b8] rounded-lg' size="xl" >Jetzt Auftrag Finden<FaArrowRightLong className="ml-2 h-5 w-5" /></Button>
                    </div>
                    <div className="flex justify-center items-center pt-6 gap-4 px-4">
                      <div className="flex items-center">
                        <FaCheck />
                        <label htmlFor="free-signup" className="ml-2 block text-sm md:text-md text-gray-900">
                          Kostenlos anmelden
                        </label>
                      </div>
                      <div className="flex items-center">
                        <FaCheck />
                        <label htmlFor="test-without-commitment" className="ml-2 block text-sm md:text-md text-gray-900">
